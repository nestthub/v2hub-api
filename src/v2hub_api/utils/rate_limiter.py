...
from v2hub_api.services.whitelist_service import WhitelistService, get_whitelist_service
...
class RateLimiter:
    ...
    def __init__(
        ...
        self._whitelist_service: WhitelistService | None = None
    ...
    async def _get_whitelist_service(self) -> WhitelistService | None:
    ...
    async def check_public_limit(self, ip: str) -> tuple[bool, str | None]:
        ...
        try:
            ...
            return {
                ...
                "config": {
                    ...
                    "whitelisted_ips": len(
                        await whitelist_service.list_all() if whitelist_service else []
                    ),
                },
            }
