...
from v2hub_api.db.models import ProxyConfig
...
class ProxyConfigRepository(BaseRepository[ProxyConfig]):
    ...
    async def get_by_hash(self, config_hash: str) -> ProxyConfig | None:
        """Get config by hash."""
        return await self.get_by_id(config_hash)

    async def create_config(self, config_hash: str, config_data: str, protocol: str) -> ProxyConfig:
    ...
    async def get_or_create(self, config_hash: str, config_data: str, protocol: str) -> ProxyConfig:
