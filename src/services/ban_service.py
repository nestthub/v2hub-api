...
class BanService:
    ...
    async def ban_ip(self, ip: str, duration_seconds: Optional[int] = None) -> None:
        """
        ...
        try:
            ...
            logger.warning(
                f"IP {ip} MANUALLY BANNED until {ban_until.isoformat()} "
...
_ban_service: Optional[BanService] = None


async def get_ban_service() -> Optional[BanService]:
