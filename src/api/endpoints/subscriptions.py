...
from src.api.dependencies import CurrentUser, SubscriptionServiceDep, ResolverServiceDep
...
def convert_sources_to_out(subscription: Subscription) -> List[SourceOut]:
    ...
    comment_map = {
        cc.config_hash: cc.comment 
        for cc in subscription.config_comments
    }
...
async def list_subscriptions(
    ...
    try:
        ...
        for subscription in subscriptions:
            ...
            result.append(SubscriptionListItem(
                token=subscription.token,
                name=subscription.name,
                description=subscription.description,
                sources_count=sources_count,
