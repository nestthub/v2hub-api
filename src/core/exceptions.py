...
class InvalidConfigError(ValidationError):
    ...
    def __init__(self, config: str, errors: list[str] | None = None):
        super().__init__(
...
class ConflictError(VPNSubscriptionError):
    ...
    def __init__(self, message: str, conflicting_field: str | None = None):
        super().__init__(
            message=message,
...
class DuplicateNameError(ConflictError):
    ...
    def __init__(self, name: str):
        super().__init__(
            message=f"Subscription name '{name}' already exists",
...
class TooManyConfigsError(VPNSubscriptionError):
    ...
    def __init__(self, count: int, max_count: int):
        super().__init__(
            message=(
                f"Resolved configuration count ({count}) exceeds "
...
class TooManySourcesError(VPNSubscriptionError):
    ...
    def __init__(self, count: int, max_count: int):
        super().__init__(
            message=(
                f"Source count ({count}) exceeds maximum allowed ({max_count})"
            ),
...
class TooManySubscriptionsError(VPNSubscriptionError):
    ...
    def __init__(self, count: int, max_count: int):
        super().__init__(
            message=(
                f"Subscription count ({count}) exceeds maximum allowed ({max_count})"
            ),
...
def to_http_exception(exc: Exception) -> HTTPException:
    ...
    if isinstance(exc, PydanticErrorMixin):
        return HTTPException(
